...
export const Footer = () => {
  ...
  return (
    <motion.footer
      className="flex flex-col  items-center justify-around w-full  text-sm   flex-wrap  lg:justify-between overflow-hidden gap-5  py-10 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] border-t border-violet-500/50 text-gray-500 bg-[#090014]"
      initial="hidden"
      whileInView="visible"
    ...
    <div class="flex items-center gap-4 mt-8 text-violet-500">
